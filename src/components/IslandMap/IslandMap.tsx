...
import { detectMapFeature } from './mapHitTest';
import type { MapFeatureType } from './mapHitTest';
import { drawFeatureHighlight } from './layers/highlightLayer';
import styles from './IslandMap.module.css';

export type { MapFeatureType } from './mapHitTest';
